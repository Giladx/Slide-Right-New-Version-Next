  ...
  return (
    <>
      <div className="privacy-policy-container">
        ...
        <ScrollCode rootClassName="scroll-code-root-class-name1"></ScrollCode>
        <div className="privacy-policy-main">
          ...
          <div className="privacy-policy-data">
            <span data-aos="fade" className="privacy-policy-text01">
              Privacy policy
            </span>
            <span data-aos="fade" className="privacy-policy-text02">
            ...
            <span data-aos="fade" className="privacy-policy-text03">
            ...
            <span data-aos="fade" className="privacy-policy-text04">
              Collection of information
            </span>
            <span data-aos="fade" className="privacy-policy-text05">
              ...
              information regarding the usage and traffic of the Services. This
              statistical information is not otherwise aggregated in such a way
              that would identify any particular user of the system.
            </span>
            <span data-aos="fade" className="privacy-policy-text06">
              Privacy of children
            </span>
            <span data-aos="fade" className="privacy-policy-text07">
              <span>
                ...
                Services. If you have reason to believe that a child under the
            ...
            <span data-aos="fade" className="privacy-policy-text10">
              <span>
            ...
            <span data-aos="fade" className="privacy-policy-text13">
              Use and processing of collected information
            </span>
            <span data-aos="fade" className="privacy-policy-text14">
            ...
            <span data-aos="fade" className="privacy-policy-text15">
            ...
            <span data-aos="fade" className="privacy-policy-text16">
            ...
            <span data-aos="fade" className="privacy-policy-text17">
            ...
            <span data-aos="fade" className="privacy-policy-text18">
              <span>- Respond to inquiries and offer support</span>
              <br></br>
              <span>- Run and operate the Services</span>
            </span>
            <span data-aos="fade" className="privacy-policy-text22">
            ...
            <span data-aos="fade" className="privacy-policy-text23">
            ...
            <span data-aos="fade" className="privacy-policy-text24">
              Disclosure of information
            </span>
            <span data-aos="fade" className="privacy-policy-text25">
            ...
            <span data-aos="fade" className="privacy-policy-text26">
            ...
            <span data-aos="fade" className="privacy-policy-text27">
              Retention of information
            </span>
            <span data-aos="fade" className="privacy-policy-text28">
            ...
            <span data-aos="fade" className="privacy-policy-text29">
            ...
            <span data-aos="fade" className="privacy-policy-text30">
              Cookies
            </span>
            <span data-aos="fade" className="privacy-policy-text31">
            ...
            <span data-aos="fade" className="privacy-policy-text32">
            ...
            <span data-aos="fade" className="privacy-policy-text33">
              Data analytics
            </span>
            <span data-aos="fade" className="privacy-policy-text34">
              ...
              improve our Services. We do not use third-party analytics tools to
              track or to collect any personally identifiable information of our
              Users and we will not associate any information gathered from the
              statistical reports with any individual User.
            </span>
            <span data-aos="fade" className="privacy-policy-text35">
              Do Not Track signals
            </span>
            <span data-aos="fade" className="privacy-policy-text36">
              ...
              they move across different websites over time. The Services do not
              track its visitors over time and across third-party websites.
              However, some third-party websites may keep track of your browsing
              activities when they serve you content, which enables them to
              tailor what they present to you. For a description of Do Not Track
              protocols for browsers and mobile devices or to learn more about
              the choices available to you, visit internetcookies.com
            </span>
            <span data-aos="fade" className="privacy-policy-text37">
              Social media features
            </span>
            <span data-aos="fade" className="privacy-policy-text38">
            ...
            <span data-aos="fade" className="privacy-policy-text39">
              Email marketing
            </span>
            <span data-aos="fade" className="privacy-policy-text40">
            ...
            <span data-aos="fade" className="privacy-policy-text41">
            ...
            <span data-aos="fade" className="privacy-policy-text42">
              Push notifications
            </span>
            <span data-aos="fade" className="privacy-policy-text43">
            ...
            <span data-aos="fade" className="privacy-policy-text44">
              Links to other resources
            </span>
            <span data-aos="fade" className="privacy-policy-text45">
            ...
            <span data-aos="fade" className="privacy-policy-text46">
              Information security
            </span>
            <span data-aos="fade" className="privacy-policy-text47">
            ...
            <span data-aos="fade" className="privacy-policy-text48">
            ...
            <span data-aos="fade" className="privacy-policy-text49">
              Data breach
            </span>
            <span data-aos="fade" className="privacy-policy-text50">
            ...
            <span data-aos="fade" className="privacy-policy-text51">
              Changes and amendments
            </span>
            <span data-aos="fade" className="privacy-policy-text52">
            ...
            <span data-aos="fade" className="privacy-policy-text53">
            ...
            <span data-aos="fade" className="privacy-policy-text54">
              Acceptance of this policy
            </span>
            <span data-aos="fade" className="privacy-policy-text55">
              ...
              not authorized to access or use the Services. This privacy policy
              was created with the help of WebsitePolicies.com
            </span>
            <span data-aos="fade" className="privacy-policy-text56">
              Contacting us
            </span>
            <span data-aos="fade" className="privacy-policy-text57">
            ...
            <span data-aos="fade" className="privacy-policy-text58">
              <span>https://sliderightNOW.com</span>
              <br></br>
              <span>info@sliderightNOW.com</span>
            </span>
            <span data-aos="fade" className="privacy-policy-text62">
            ...
            <span data-aos="fade" className="privacy-policy-text63">
